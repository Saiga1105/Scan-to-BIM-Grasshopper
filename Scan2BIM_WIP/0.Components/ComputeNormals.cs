...
{
    public class PCD_normals2 : GH_Component
    {
        /// <summary>
        ...
        {
            pManager.AddParameter(new GH_PointCloudParam01(),"Point Cloud", "PCD", "Point Cloud data", GH_ParamAccess.item); pManager[0].Optional = false;
        ...
        {
            pManager.AddParameter(new GH_PointCloudParam01(), "Point Cloud", "PCDn", "Point Cloud data with normals", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            GH_PointCloud01 pc = null;

            //PointCloud pointCloud_out = new PointCloud();
            Double k = 6;
