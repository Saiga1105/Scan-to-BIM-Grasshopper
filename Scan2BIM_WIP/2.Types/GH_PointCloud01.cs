...
{
    public class GH_PointCloud01 : GH_GeometricGoo<PointCloud>, IGH_PreviewData, IGH_BakeAwareObject
    {
        /// <summary>
        ...
        /// </summary>
        public GH_PointCloud01(PointCloud cloud)
        {
            this.m_value = cloud;
        }
        ...
        /// </summary>  
        public GH_PointCloud01(GH_PointCloud01 other)
        {
        ...
        {
            return new GH_PointCloud01((PointCloud) this.m_value.Duplicate());
        }
        ...
        public override bool CastFrom(object source)
        {
            ...
            if (source.GetType() == typeof(GH_PointCloud01))
            {
                this.m_value = ((GH_PointCloud01)source).Value;
                return true;
            }
        ...
        public override bool CastTo<Q>(out Q target)
        {
            ...
            if (typeof(Q) == typeof(GH_PointCloud01))
            {
        ...
        public override IGH_GeometricGoo Transform(Transform xform)
        {
            ...
            dup.Transform(xform);
            return new GH_PointCloud01((PointCloud)dup);
        }
