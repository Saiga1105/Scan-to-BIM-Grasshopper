...
namespace Scan2BIM
{
    public class Resutructure_and_Colorize_PCD : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent2 class.
        /// </summary>
        public Resutructure_and_Colorize_PCD()
          : base("Restructure&Colorize_PCD", "Restructure",
              "Restructure and randomly colorize Point Cloud according to the computed indices of the regions (E.g. Region_Growing_PCD) ",
              "Saiga", "Segmentation")
        {
        }
        ...
        {
            get { return new Guid("32a82c54-349a-4aea-9966-53ed5c29fcd2"); }
        }
    }
}